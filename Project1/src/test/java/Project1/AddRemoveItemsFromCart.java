...
import ProjectPageObjects.ProductPage;
import ProjectPageObjects.ShopMainPage;
import ProjectPageObjects.ShoppingCart;
...
import java.time.Duration;
    ...
    public class AddRemoveItemsFromCart extends Base {
        public AddRemoveItemsFromCart() throws IOException {
            super();
        }
        @BeforeTest
